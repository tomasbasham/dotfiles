...
hld("@markup.heading.1", { fg = brightyellow, bold = true })
hld("@markup.heading.1.marker", { fg = yellow, bold = true })

hld("@markup.heading.2", { fg = magenta, bold = true })
hld("@markup.heading.2.marker", { fg = brightmagenta, bold = true })

hld("@markup.heading.3", { fg = cyan, bold = true })
hld("@markup.heading.3.marker", { fg = brightcyan, bold = true })

hld("@markup.heading.4", { fg = cyan, bold = true })
hld("@markup.heading.4.marker", { fg = brightcyan, bold = true })

hld("@markup.heading.5", { fg = cyan, bold = true })
hld("@markup.heading.5.marker", { fg = brightcyan, bold = true })

hld("@markup.heading.6", { fg = cyan, bold = true })
hld("@markup.heading.6.marker", { fg = brightcyan, bold = true })

hld("@markup.link.markdown_line", { fg = brightblue, underline = true })
hld("@markup.link.label.markdown_inline", { fg = magenta })
hld("@markup.link.url.markdown_inline", { fg = brightblue, underline = true })

hld("@markup.raw.markdown_inline", { fg = brightred, italic = true })
hld("@markup.raw.delimiter.markdown", { fg = brightred, italic = true })
