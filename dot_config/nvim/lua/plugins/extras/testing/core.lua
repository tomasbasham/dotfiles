return {
  {
    ...
    opts = {
      ...
      -- adapter names, or a table of adapter names, mapped to adapter configs.
      --
      -- The adapter will then be automatically loaded with the config. Adapters
      -- will usually be configured alongside other language specific
      -- configuraitons.
      --
      -- See [extras/lang/] for examples.
      adapters = {},
      status = {
        virtual_text = true,
      },
